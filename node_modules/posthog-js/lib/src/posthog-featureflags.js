...
var PostHogFeatureFlags = /** @class */ (function () {
    ...
    PostHogFeatureFlags.prototype.getFeatureFlagResult = function (key, options) {
        ...
        if (this._instance.config.advanced_feature_flags_dedup_per_session) {
            ...
            var storedSessionId = this._instance.get_property(constants_1.FLAG_CALL_REPORTED_SESSION_ID);
        ...
        if (options.send_event || !('send_event' in options)) {
            if (!(key in flagCallReported) || !flagCallReported[key].includes(flagReportValue)) {
                ...
                (_d = this._instance.persistence) === null || _d === void 0 ? void 0 : _d.register((_b = {}, _b[constants_1.FLAG_CALL_REPORTED] = flagCallReported, _b));
                var flagDetails = this.getFeatureFlagDetails(key);
                var errors = __spreadArray([], __read(((_e = this._instance.get_property(constants_1.PERSISTENCE_FEATURE_FLAG_ERRORS)) !== null && _e !== void 0 ? _e : [])), false);
                ...
                var properties = {
                    ...
                    $feature_flag_bootstrapped_response: ((_g = (_f = this._instance.config.bootstrap) === null || _f === void 0 ? void 0 : _f.featureFlags) === null || _g === void 0 ? void 0 : _g[key]) || null,
                    $feature_flag_bootstrapped_payload: ((_j = (_h = this._instance.config.bootstrap) === null || _h === void 0 ? void 0 : _h.featureFlagPayloads) === null || _j === void 0 ? void 0 : _j[key]) || null,
    ...
    PostHogFeatureFlags.prototype.overrideFeatureFlags = function (overrideOptions) {
        ...
        if (overrideOptions &&
            ...
            if ('flags' in options) {
                if (options.flags === false) {
                    ...
                    if ((0, core_1.isArray)(options.flags)) {
                        ...
                        this._instance.persistence.register((_b = {}, _b[PERSISTENCE_OVERRIDE_FEATURE_FLAGS] = flagsObj, _b));
                    }
                    else {
                        this._instance.persistence.register((_c = {}, _c[PERSISTENCE_OVERRIDE_FEATURE_FLAGS] = options.flags, _c));
                    }
            ...
            if ('payloads' in options) {
                if (options.payloads === false) {
                    ...
                    this._instance.persistence.register((_d = {},
        ...
        if (overrideOptions && typeof overrideOptions === 'object') {
            this._instance.persistence.register((_e = {},
